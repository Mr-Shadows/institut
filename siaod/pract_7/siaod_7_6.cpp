...
int main() {
    ...
    int choice;
    std::cout << "Select of variant:\n";
    std::cout << "1. The original field\n";
    std::cout << "2. Manual field entry\n";
    std::cin >> choice;
    ...
    if (choice == 1) {
        ...
        // Ручной ввод поля
        std::cout << "Enter the field sizes n and m: ";
        std::cin >> n >> m;

        std::cout << "Enter the values of the cells in the field:\n";
        ...
        std::cout << "Wrong choice. The program is ending.\n";
        return 1;
    }
    ...
    std::cout << "Minimum route weight: " << dp[n - 1][m - 1] << std::endl;
